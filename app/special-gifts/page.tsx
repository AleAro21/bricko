                        ...
                        <div className="space-y-6">
                            <div>
                                ...
                                <p className="text-[16px] text-[#1d1d1f] leading-6 mb-4">
                                    En una herencia, el heredero sucede al testador en la titularidad de sus bienes, y también de sus deudas, y adquiere todos los derechos y obligaciones que no se extingan con la muerte del causante. En cambio, en un <span className="font-bold">legado</span>, el legatario adquiere bienes concretos, pero sin responder del pasivo de la herencia.
                                </p>
                            </div>

          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1.5fr,1fr] gap-8 lg:gap-24">
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-2xl shadow-md p-8">
                <div className="space-y-6">
                  <div>
                    ...
                    <textarea
                      className="w-full px-4 py-3 rounded-lg border border-gray-300 focus:border-[#047aff] focus:ring focus:ring-[#047aff] focus:ring-opacity-50 transition-all"
                      rows={4}
                  ...
                  {type === 'money' && (
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          type="number"
                          className="w-full pl-8 pr-4 py-3 rounded-lg border border-gray-300 focus:border-[#047aff] focus:ring focus:ring-[#047aff] focus:ring-opacity-50 transition-all"
                          placeholder="0.00"
                        />
                      </div>
                    </div>
              ...
              <div className="flex justify-end space-x-4">
                <button
                  onClick={() => router.back()}
                  className="px-6 py-2.5 text-[#047aff] hover:text-[#0456b0] transition-colors duration-200"
                >
                  Volver
                </button>
                <PrimaryButton

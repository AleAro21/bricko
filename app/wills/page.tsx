...
const accordionData: AccordionItem[] = [
  {
    title: 'Texto',
    content: 'Nuestros especialistas comprobarán su testamento en un plazo de 5 días laborables. Si recomiendan algún cambio, realice las actualizaciones dentro de los 30 días y verificarán su testamento nuevamente. Simple.'
  },
  {
    title: 'Hazlo legal',
    content: 'Para que su testamento sea legalmente vinculante, debe firmar una copia impresa frente a dos testigos. Puede optar por descargar e imprimir su testamento en casa o solicitar una copia impresa.'
  },
  {
    title: 'Mantenga su testamento al día',
    content: 'Una vez que haya firmado su testamento, es importante actualizarlo cuando cambien las circunstancias. Tradicionalmente, eso significa pagar los honorarios de un abogado o el costo de un testamento completamente nuevo. Con Testador puedes realizar cambios ilimitados por solo £10 al año; encontrarás la opción al finalizar la compra.'
  }
];
                  ...
                  <div key={index}>
                    <h2 id={`accordion-flush-heading-${index + 1}`}>
                      <button
                        ...
                        aria-expanded={activeAccordion === index + 1 ? 'true' : 'false'}
                        aria-controls={`accordion-flush-body-${index + 1}`}
                      >
                        <span className='sm-title text-start'>{item.title}</span>
                    ...
                    <div
                      ...
                      className={`${activeAccordion === index + 1 ? '' : 'hidden'}`}
            ...
            <div className='w-[50%]'>
              <div className='mt-[10vh] border rounded-lg md:w-[80%] mx-auto p-6'>
                ...
                <div className='flex gap-2'>
                  ...
                  <p className='text-style'>Envíenos un correo electrónico a ayuda@testador.com</p>
                </div>
              </div>
            </div>
          </div>

// 5. Keep PaymentClient.tsx with all your UI and animations
...
const PaymentClient: FC = () => {
  ...
  const paymentAmount = 2499; // You can make this dynamic if needed
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-5 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-24">
            ...
            <div>
              <PaymentSummary amount={paymentAmount} />
            </div>
          </div>
        </div>
      </motion.div>
